...
% Include supplement-only references so numbering matches combined.tex
\nocite{KINA,KarolinskaEmployees,Ledamotsregister,NPPWiki,NobelCommitteeChemistry,NobelCommitteePhysics,NobelCommitteePhysiology,NobelPrizeWebsite,NobelPrizeWebsiteFull,NorwegianNobelCommittee,RSAS,wikidata}
