...
% Use pre-built .bbl from combined.tex to ensure unified reference numbering.
% Do NOT use \bibliography{} here — Overleaf would rerun BibTeX and overwrite
% the manually provided supplement.bbl with independent numbering.
