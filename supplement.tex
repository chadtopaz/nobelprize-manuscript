...
To characterize layer composition, we compute the \emph{effective number of categories} as $\exp(-\sum_i p_i \log p_i)$, the exponential of Shannon entropy. This gives the equivalent number of equally represented categories: 1 indicates perfect concentration; higher values indicate greater diversity. At the country level, 84.7\% of governing body members and 96.3\% of vetting body members were born in Sweden, Norway, or Denmark, confirming the Scandinavian concentration of the institutional layers.
